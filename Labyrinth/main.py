...
labyrinth = {
  ...
  'north7': {
    'description':
    'As you explore the next room, you see a locked door in the distance. You try to open it, but it doesnt budge. You examine the lock, but it seems to be magically sealed. Frustrated, you turn around and notice a friendly spirit floating towards you. As she comes closer, you see a key hanging from her neck. She greets you warmly and asks if you need help. You explain your situation, and she nods understandingly. However, she tells you that she cannot simply give you the key - you must prove that you are worthy of it. She explains that she requires three items: a healing potion, a sword, and a shield. If you have these items, she will heal you and give you the key. If not, you must go back and find them.'
  ...
  'east6': {
    'description':
    'This room is much larger than the others, and the air is thick with a musty scent that makes it hard to breathe. You feel the weight of the darkness pressing down on you as you take a step forward. Suddenly, you hear a blood-curdling scream that echoes throughout the room, and the shadows come to life. You try to run, but the shadows attack you, devouring your sense of reality causing a mental distortion so powerful that it consumes you entirely. You lose all sense of reality, and you find yourself in a dark void where there is no escape. death is now your only option. so you wait ',
    'items': [],
    'exits': {
      'death': 'entrance'
    }  # fix this logic
  ...
  'north2east3': {
    'description':
    'You continue down the narrow hallway, torch in hand, and notice that the shadows seem to be morphing into something different. Theyre no longer just dark and menacing, but now they seem to be pulsating with a strange energy. You can feel the hairs on the back of your neck stand up as the hallway becomes colder and colder. You can see your breath in the air, and you wonder what kind of twisted world youve stumbled into. As you reach the end of the hallway, you find yourself in a room with four doors, each leading in a different direction. The room is even colder than the hallway, and you can see your breath in the air more clearly now. The shadows in the room seem to be alive, swirling and pulsing with an otherworldly energy. You can hear strange whispers in the air, and you wonder if youre losing your mind. As you explore the room, you notice a stone in the center of the room with strange markings on it (L). As you look closer, you realize that the markings are a message of sorts, telling you how to survive in this mental prison. It reads three keys are required. The message is cryptic, but you realize that you need to keep moving forward, always forward, and never look back. Confused and disoriented, you must make a choice of which door to take next, but all you can do is follow the message on the stone and hope that you will find your way out of this twisted reality.',
    'items': [],
    'exits': {
      'north': 'north3east3',
      'south': 'north1east3',
  ...
  'north6east5': {
    'description':
    'As you explore the room, you notice that there is a hidden door in the corner (XXX). You wonder if it leads to a way out, or if its just another trap. You must make a decision quickly, as the creature is getting closer and closer. With a sense of desperation, you run towards the hidden door. ',
    'items': [],
    # add puzzle
    'exits': {
      'north': 'north7east5',
      'south': 'north5east5',
      'hiddendoor': 'north6east4'
    }
  },
  'north7east1': {
    'description': '',
...
if player_location == 'north4':
  print(
    "Here's a puzzle for you: What has four legs in the morning, two legs in the afternoon, and three legs in the evening?"
  )
  ...
  print(
    "Here's a puzzle for you: I am always hungry, I must always be fed. The finger I touch will soon turn red. What am I?"
  )
  answer = input("Your answer: ")
  ...
  print(
    "Here's a puzzle for you: The more you take, the more you leave behind. What am I?"
  )
  answer = input("Your answer: ")
...
def fight():
  ...
  while playerPoints > 0 or guardPoints > 0:
    ...
    if attack.lower(
    ) == "heavy":  # if attack is heavy, it deals more damage but is less likely to hit
    ...
    ) == "light":  # player chooses light attack, less damage but higher probability of hitting
      playerChance = random.randrange(1, 10)
  ...
  if guardPoints == 0:
    print(
      "The guard stumbles backwards and collapses in a heap on the floor. He is defeated."
    )
    return True
  elif playerPoints == 0:
    print(
      "The guards last attack leaves you feeling weak...trying to keep your balance...eyes getting heavy...hard to breathe......."
    )
    return False
